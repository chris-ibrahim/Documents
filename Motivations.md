...
###Pourquoi une thèse en IA argumentation
J'ai envie de faire de l'IA qui touche de points plus fondamentaux de la cognition et pas juste une thèse qui utilise déjà des méthodes de deep learning et autre déjà bien développés.

###Pourquoi une thèse au LAAS ou à l'IRIT pourquoi pas au Luxembourg?
Dire que tu veux aller aux conférences au Luxembourg et éventuellement établir des partenariats durables
Ce sont deux labos que j'aime bien parce que j'apprécie le travail qu'ils font et je rêve de travailler parmi les profs qui m'ont enseigné que j'admire 

###Pourquoi leur sujet de thèse en particulier (synthèse : il faut que ce soit convaincant)


###Où en est ta recherche de thèse
Chez qui tu as postulé Voir page du 1er mai de ton carnet pour l'expliquer.
...
## 1ASRI
###Fil rouge (peut-être pas pertinent)
### Robot cartopgraphieurs pourquoi pas? (justifier des notes)
## 2ASRI
### TER (peut-être pas pertinent)  (justifier des notes)
### Le labyrinthe en Qlearning  (justifier des notes)
### Le parcours d'arbre en recherche opérationnel  (justifier des notes)
## 3ASRI
## Projet SMA
...
Pour ce stage je serai prêt à fournir le meilleur travail que j'ai jamais fait depuis que je suis étudiant.

#Ce que tu peux leur proposer : ce que tu es capable de faire, ce que tu es prêt à faire et ce que tu as envie de faire
Il faut qu'il sache ce que tu sais faire

##tes compétences/qualité
Je suis bon dans les matières plutôt calculatoires. Je suis un programmeur correct, mais j'aime comprendre les principes théoriques derrière ce que je fais. j'aidre les maths,j'adore apprendre, je sais travaillé en équipe je sais être réactif sans trop m'imposer, je suis persévérent et je ne compte pas mes heures sur ce que je fais.

J'ai eu le temps durant mon cursus, en L1 SFA et en 2eme année EEA de manipuler pas mal d'outils mathématiques, avant d'en faire beaucoup moins à l'upssitech et faire beaucoup plus de l'informatiques

##ta vision (tu regardes tes videos de philosophies, tu vas à toutes les conférences que tu peux)
...
Mais du coup, pourquoi un historien ne serait pas considéré comme un scientifique? Ils utilisent bien un paradygme où plutôt une méthode rigoureuse dans leur travail, non? 
...
##ce que tu es capable de faire, ce qe tu as envie de faire, ce que tu serais prêt à faire

#Quels sont leurs projets pour cette thèse
S'inscrit t-elle dans un projet européens, un test grandeur nature sera-t-il, s'agit-il uniquement d'une simulation numérique ou elle sera déploy sur un véhicule concret?
...
Précise en disant ce que tu fais qui le prouve


#Expliquer pourquoi tu as des notes aussi basses en IA/Mais ne te dit pas non plus qu'ils seront si consternés que sa par tes notes (ce ne sont que des chiffres)
Je n'ai pas vraiment compris pourquoi j'ai eu des notes aussi basses en IA. Ce sont les matières que j'adorais le plus et auxquelles je participais le plus et était le plus réactif en cour pourtant, en tout si ces matières étaient encore à repasser, je les aurais bien fait volontiers.
...
En fait pendant les exams je n'ai jamais aucune idée de la note que j'aurai. C'est toujours une question de chances parce que souvent on a pas le temps de bien finir tous les exercices qui y sont m^me si on a beau avoir bien réisé. 
Il y a toujours très peu de diversité de questions alors que lon a souvent révisée plus plsusieurs chapitres
